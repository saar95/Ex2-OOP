...
public class Ex2test{
    ...
    private static HashMap<CL_Agent,HashMap<CL_Pokemon,List<node_data>>> matchPokemonsToAgents(List<CL_Pokemon> pokemonList, List<CL_Agent> agentList, dw_graph_algorithms startGraph){
